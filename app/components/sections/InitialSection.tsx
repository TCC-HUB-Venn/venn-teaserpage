...
import { HeroProductPreview } from "../ui/Mockup/HeroProductPreviewMockup";
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center md:gap-10 lg:flex-row lg:items-center lg:gap-0 lg:pr-16">
        ...
        {/* Motion Mobile */}
        <div className="relative order-2 flex h-[400px] w-full justify-center lg:hidden">
          <motion.div
            animate={{ y: [0, -20, 0] }}
            transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
            className="relative h-full w-full sm:w-[75%] sm:max-w-[440px]"
          >
            <motion.div
              className="absolute left-1/2 top-1/2 h-[260px] w-[260px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/20 blur-[110px] sm:h-[320px] sm:w-[320px]"
              animate={{
                scale: [1, 1.08, 1],

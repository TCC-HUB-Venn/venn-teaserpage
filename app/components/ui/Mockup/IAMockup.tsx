        ...
        >
            ...
            <div className='flex items-center justify-between'>
                ...
                <motion.div
                    ...
                    className='font-medium flex gap-2 items-center justify-center rounded-full bg-red-600/20 border border-red-600/30 px-3 py-1.5 w-fit text-red-200 text-sm'
                >
            ...
            <motion.div
                ...
                <div>
                    ...
                    <p className="mt-2 text-white/60">
                        Beatriz M. não abre a plataforma há 12 dias.
                        Risco de abandono:
